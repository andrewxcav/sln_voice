...
# Tile Targets
#**********************
set(TARGET_NAME tile0_example_ffd_sensory_sq66)
...
set(TARGET_NAME tile1_example_ffd_sensory_sq66)
add_executable(${TARGET_NAME} EXCLUDE_FROM_ALL)
target_sources(${TARGET_NAME} PUBLIC ${APP_SOURCES})
target_include_directories(${TARGET_NAME} PUBLIC ${APP_INCLUDES} ${RTOS_CONF_INCLUDES})
...
# Merge binaries
#**********************
merge_binaries(example_ffd_sensory_sq66 tile0_example_ffd_sensory_sq66 tile1_example_ffd_sensory_sq66 1)

#**********************
# Create run and debug targets
#**********************
create_run_target(example_ffd_sensory_sq66)
create_debug_target(example_ffd_sensory_sq66)

#**********************
# Create data partition support targets
#**********************
set(TARGET_NAME example_ffd_sensory_sq66)
