...
// static rtos_intertile_t mclk_intertile_ctx_s;
// rtos_intertile_t *mclk_intertile_ctx = &mclk_intertile_ctx_s;

// static rtos_intertile_t asr_intertile_ctx_s;
// rtos_intertile_t *asr_intertile_ctx = &asr_intertile_ctx_s;

// static rtos_intertile_t mic_array_intertile_ctx_s;
// rtos_intertile_t *mic_array_intertile_ctx= &mic_array_intertile_ctx_s;
