...
add_library(sln_voice_app_ffd_board_support_xk_robokit INTERFACE)
target_sources(sln_voice_app_ffd_board_support_xk_robokit
    INTERFACE
...
target_include_directories(sln_voice_app_ffd_board_support_xk_robokit
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}
)
target_link_libraries(sln_voice_app_ffd_board_support_xk_robokit
    INTERFACE
        core::general
        rtos::freertos
...
target_compile_options(sln_voice_app_ffd_board_support_xk_robokit
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}/XK_ROBOKIT.xn
)
target_link_options(sln_voice_app_ffd_board_support_xk_robokit
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}/XK_ROBOKIT.xn
)
target_compile_definitions(sln_voice_app_ffd_board_support_xk_robokit
    INTERFACE
        XK_ROBOKIT=1
...
## Create an alias
add_library(sln_voice::app::ffd::xk_robokit ALIAS sln_voice_app_ffd_board_support_xk_robokit)
